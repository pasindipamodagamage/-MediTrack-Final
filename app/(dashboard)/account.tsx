...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: "800", color: "#4A90E2", letterSpacing: -0.5 },
  scrollView: { flex: 1 },
  ...
  editButton: { backgroundColor: "#4A90E2", paddingHorizontal: 24, paddingVertical: 12, borderRadius: 25, marginBottom: 24 },
  ...
  input: { backgroundColor: "#f8f8f8", padding: 16, borderRadius: 12, borderWidth: 1, borderColor: "#e0e0e0", fontSize: 16, color: "#4A90E2" },
  ...
  infoCardValue: { fontSize: 18, color: "#4A90E2", fontWeight: "600" },
